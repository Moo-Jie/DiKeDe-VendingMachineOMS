<template>
  <div class="box home-user-task-stats bgc1">
    ...
    <div v-if="userTaskStats.length" class="body">
      <div class="stats">
        <div class="item">
          <div class="text color2">工单总数</div>
      ...
      <div class="stats">
        <div class="item">
          <div class="text color2">完成工单数</div>
          <div class="num color1 text-shadow1">
            {{
      ...
      <div class="stats">
        <div class="item">
          <div class="text color2">进行工单数</div>
          <div class="num color1 text-shadow1">
            {{
      ...
      <div class="stats">
        <div class="item">
          <div class="text color2">取消工单数</div>
          <div class="num color1 text-shadow1">
  ...
  .body {
    ...
    .stats {
      ...
      .item {
        ...
        .text-shadow2 {
          text-shadow: 2px 4px 7px rgba(85, 255, 201, 0.5);
        }
      }
    }
  }
...
.bgc2 {
  background: #88fcee url('@/assets/images/sale.png') no-repeat calc(100% - 12px) 100%;
}
</style>